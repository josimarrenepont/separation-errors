...
public class SeparationControllerTests {
    ...
    public void testFindAll() throws Exception{
        ...
        when(separationService.findAll()).thenReturn(separationList);
    ...
    public void testFindById() throws Exception{
        when(separationService.findById(1L)).thenReturn(separation);
    ...
    public void testUpdateSeparationErrors() throws Exception{
        when(separationService.updateErrors(1L, separation)).thenReturn(separation);
    ...
    public void testAddError() throws Exception{
        when(separationService.addError(separation)).thenReturn(separation);
